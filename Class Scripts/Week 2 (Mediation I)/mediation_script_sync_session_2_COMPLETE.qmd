...
source("G:/My Drive/FlashDrive/Teaching Materials/PSYC489K (MedMod)/process_v5.R")
```
...
```{r}
# store data in an object called warvet"G:/My Drive/FlashDrive/Teaching Materials/PSYC489K (MedMod)/
warvet <- read.csv(file = "G:/My Drive/FlashDrive/Teaching Materials/PSYC489K (MedMod)/Datasets/ptsd_vet_ic2.csv")
